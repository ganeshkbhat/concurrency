            ...
            // return new Promise((resolve, reject) => {
                ...
                worker.on("connection", (e) => {
                    ...
                    if (!!options.handlers.connection) {
                        ...
                        result.push({ message: cbFunction(e), pid: null, event: "connection" });
                    }
                });
                ...
                worker.on("message", function (mainData) {
                    ...
                    if (!!options.handlers.message) {
                        ...
                        result.push({ message: cbFunction(mainData), pid: null, event: "message" });
                    }
                    if (!!mainData.closeChild) {
                        ...
                        resolve({ messageData, childMessageData, result });
                    }
                ...
                worker.on("online", () => {
                    if (!!options.handlers.online) {
                        ...
                        result.push({ message: cbFunction(), pid: null, event: "online" });
                    }
                ...
                worker.on("error", (e) => {
                    if (!!options.handlers.error) {
                        ...
                        result.push({ message: cbFunction(e), pid: null, event: "error" });
                    }
                    reject(e)
                });
                ...
                worker.on("messageerror", (e) => {
                    if (!!options.handlers.messageerror) {
                        ...
                        result.push({ message: cbFunction(e), pid: null, event: "messageerror" });
                    }
                    reject(e)
                });
                ...
                worker.on("close", (e) => {
                    ...
                    if (!!options.handlers.close) {
                        ...
                        result.push({ message: cbFunction(e), pid: null, event: "close" });
                    }
                    // resolve({ messageData, childMessageData, result });
                });
                ...
                worker.on("exit", (code) => {
                    ...
                    if (!!options.handlers.exit) {
                        ...
                        result.push({ message: cbFunction(code), pid: null, event: "exit" });
                    }
                    if (code !== 0) {
